...
public class MyDrawer3 extends JPanel {
	...
	public MyDrawer3(Color initColor) {
...
class Point implements Serializable {	// 如果沒實作序列化則不行使用ObjectIO類別輸出
	public int x, y;
}
class Line implements Serializable {	// 如果沒實作序列化則不行使用ObjectIO類別輸出
